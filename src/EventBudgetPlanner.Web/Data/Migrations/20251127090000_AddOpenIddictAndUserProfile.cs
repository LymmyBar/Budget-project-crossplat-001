...
namespace EventBudgetPlanner.Web.Data.Migrations
{
    ...
    [Migration("20251127090000_AddOpenIddictAndUserProfile")]
    public partial class AddOpenIddictAndUserProfile : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpenIddictAuthorizations_Subject_Status_Type",
                table: "OpenIddictAuthorizations",
                columns: new[] { "Subject", "Status", "Type" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpenIddictTokens_Subject_Status_Type",
                table: "OpenIddictTokens",
                columns: new[] { "Subject", "Status", "Type" });
        }
